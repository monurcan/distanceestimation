...
class DistNet_v14(pl.LightningModule):
    def __init__(self, pretrained=True, learning_rate=1e-3):
        super(DistNet_v14, self).__init__()
    ...
    def forward(self, roi, bounding_box_with_class):
        ...
        predicted_plane_normal_a = predicted_small_roll
        predicted_plane_normal_b = self.plane_normal_b
        predicted_plane_normal_c = -predicted_small_pitch
