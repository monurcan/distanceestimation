...
# Use dataloader_v6
# for dearsan
class DistNet_v31(pl.LightningModule):
    def __init__(self, learning_rate=1e-3):
        super(DistNet_v31, self).__init__()
        ...
        self.roi_backbone = models.swin_v2_t(weights="DEFAULT")
        # print(dir(self.roi_backbone))
        # print(self.roi_backbone)
        in_features_roi = self.roi_backbone.head.in_features
        self.backbone_output_size = 128
        self.roi_backbone.head = nn.Sequential(
