...
class YOLOLikeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for selected_line_i in range(len(valid_annotations)):
            ...
            bb_feature = self.feature_extractor([roi])
            selected_feature_tensor = torch.tensor(bb_feature.squeeze())

            print(selected_feature_tensor.shape)
            print(bounding_box_with_class.shape)
